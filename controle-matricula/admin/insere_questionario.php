    ...
    <body>
        ...
        if (isset($_POST['Enviar'])) {
           ...
           if(mysqli_query($link, $sql)){
                $msg="<div class='ls-alert-success'><strong>Atenção:</strong>O Questionário Sócioeconômico Educacional foi salvo com sucesso!   </div>";
        ...
        <main class="ls-main ">
            <div class="container-fluid">
                <h1 class="ls-title-intro ls-ico-home">QUESTINÁRIO SOCIOECONÔMICO EDUCACIONAL</h1>
                    ...
                    <div class="ls-modal-box">
                        ...
                        <form name="form"  method="post">
                            ...
                            <div class="ls-modal-footer">
                                ...
                                <button type="submit" class="ls-btn-primary" name="Enviar">Enviar</button> 
