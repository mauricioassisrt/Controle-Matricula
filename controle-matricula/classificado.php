...
$query = sprintf("select a.aca_nome, a.aca_pontuacao, a.aca_classificacao,a.cur_id, c.cha_convocacao from academicos a, chamada c where a.aca_id=c.aca_id and $ids= cur_id order by a.aca_classificacao;");
// executa a query 
